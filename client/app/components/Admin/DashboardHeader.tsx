...
const DashboardHeader: FC<Props> = ({ open, setOpen }) => {
  ...
  return (
    <div className='w-full flex items-center justify-end p-6 fixed dark:bg-[#2a2a2a]  z-[999] right-0'>
      <ThemeSwitcher />
      <div
      ...
      <div>
        {open && (
          <div className='w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 right-10 z-10 rounded'>
